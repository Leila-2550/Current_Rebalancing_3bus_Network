...
########
## 5- Injecting the compensation current as current sources to the middle bus
OpenDSSDirect.Text.Command("New ISource.IDG1 Bus1=2.1.4 Phases=1  , amps = $mag1_I_comp, ang = $ang1_I_comp")
OpenDSSDirect.Text.Command("New ISource.IDG2 Bus1=2.2.4 Phases=1  , amps = $mag2_I_comp, ang = $ang2_I_comp")
OpenDSSDirect.Text.Command("New ISource.IDG3 Bus1=2.3.4 Phases=1  , amps = $mag3_I_comp, ang = $ang3_I_comp")
...
#get voltage before solving the network with the compensation
