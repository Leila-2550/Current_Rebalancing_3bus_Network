...
### 4- Inject Compensation Current at the middle bus of feeder 1
for (i, phase) in enumerate(["1.4", "2.4", "3.4"])
    OpenDSSDirect.Text.Command("New ISource.IDG$i Bus1=2.$phase Phases=1  , amps = $(mag_I_comp[i]), ang = $(ang_I_comp[i])")
end
...
# --- 2. Plot Current Magnitude Comparison for Each Line ---
...
# --- 3. Combined Line Current Profile ---
line_labels = []
line_before_mags = []
line_after_mags = []
...
# --- 4. Transformer Current Magnitude Before and After Compensation ---
...
I_l12_before = Current_before["Line.line_F1_2_1"].I_complex
println("Plotting Substation Currents Before Compensation")
phasorcosine(abs(I_l12_before[1]), angle(I_l12_before[1]), ylabel=L"$i$", maglabel=L"$\hat{I12}_a$", 
    labelrsep=0.5, figsize=(7*a, 2.5*a), color="blue", linestyle="-")
phasorcosine(abs(I_l12_before[2]), angle(I_l12_before[2]), ylabel=L"$i$", maglabel=L"$\hat{I12}_b$ ", 
    labelrsep=0.5, color="green", linestyle="-", add=true)
phasorcosine(abs(I_l12_before[3]), angle(I_l12_before[3]), ylabel=L"$i$", maglabel=L"$\hat{I12}_c$ ", 
    labelrsep=0.5, color="red", linestyle="-", add=true)
phasorcosine(abs(I_l12_before[4]), angle(I_l12_before[4]), ylabel=L"$i$", maglabel=L"$\hat{I12}_n$ ", 
    labelrsep=0.5, color="black", linestyle="--", add=true)
# Show the plot for Substation Currents Before Compensation
gcf()
...
I_l12_after = Current_after["Line.line_F1_2_1"].I_complex
println("Plotting Substation Currents after Compensation")
phasorcosine(abs(I_l12_after[1]), angle(I_l12_after[1]), ylabel=L"$i$", maglabel=L"$\hat{I12}_a$", 
    labelrsep=0.5, figsize=(7*a, 2.5*a), color="blue", linestyle="-")
phasorcosine(abs(I_l12_after[2]), angle(I_l12_after[2]), ylabel=L"$i$", maglabel=L"$\hat{I12}_b$ ", 
    labelrsep=0.5, color="green", linestyle="-", add=true)
phasorcosine(abs(I_l12_after[3]), angle(I_l12_after[3]), ylabel=L"$i$", maglabel=L"$\hat{I12}_c$ ", 
    labelrsep=0.5, color="red", linestyle="-", add=true)
phasorcosine(abs(I_l12_after[4]), angle(I_l12_after[4]), ylabel=L"$i$", maglabel=L"$\hat{I12}_n$ ", 
    labelrsep=0.5, color="black", linestyle="--", add=true)
gcf()


# Plotting  Currents at line 14 Before Compensation
I_l14_before = Current_before["Line.line_F2_4_1"].I_complex
println("Plotting Substation Currents Before Compensation")
phasorcosine(abs(I_l14_before[1]), angle(I_l14_before[1]), ylabel=L"$i$", maglabel=L"$\hat{I14}_a$", 
    labelrsep=0.5, figsize=(7*a, 2.5*a), color="blue", linestyle="-")
phasorcosine(abs(I_l14_before[2]), angle(I_l14_before[2]), ylabel=L"$i$", maglabel=L"$\hat{I14}_b$ ", 
    labelrsep=0.5, color="green", linestyle="-", add=true)
phasorcosine(abs(I_l14_before[3]), angle(I_l14_before[3]), ylabel=L"$i$", maglabel=L"$\hat{I14}_c$ ", 
    labelrsep=0.5, color="red", linestyle="-", add=true)
phasorcosine(abs(I_l14_before[4]), angle(I_l14_before[4]), ylabel=L"$i$", maglabel=L"$\hat{I14}_n$ ", 
    labelrsep=0.5, color="black", linestyle="--", add=true)
# Show the plot for Substation Currents Before Compensation
gcf()
show()
...
I_l14_after = Current_after["Line.line_F2_4_1"].I_complex
println("Plotting Substation Currents after Compensation")
phasorcosine(abs(I_l14_after[1]), angle(I_l14_after[1]), ylabel=L"$i$", maglabel=L"$\hat{I14}_a$", 
    labelrsep=0.5, figsize=(7*a, 2.5*a), color="blue", linestyle="-")
phasorcosine(abs(I_l14_after[2]), angle(I_l14_after[2]), ylabel=L"$i$", maglabel=L"$\hat{I14}_b$ ", 
    labelrsep=0.5, color="green", linestyle="-", add=true)
phasorcosine(abs(I_l14_after[3]), angle(I_l14_after[3]), ylabel=L"$i$", maglabel=L"$\hat{I14}_c$ ", 
    labelrsep=0.5, color="red", linestyle="-", add=true)
phasorcosine(abs(I_l14_after[4]), angle(I_l14_after[4]), ylabel=L"$i$", maglabel=L"$\hat{I14}_n$ ", 
    labelrsep=0.5, color="black", linestyle="--", add=true)
gcf()
